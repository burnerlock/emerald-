...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_INFILTRATOR, ABILITY_PROTEAN },
    ...
    [SPECIES_FROGADIER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_GRENINJA}),
    },
    ...
    [SPECIES_GRENINJA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_PROTEAN, ABILITY_BATTLE_BOND, ABILITY_PROTEAN },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
