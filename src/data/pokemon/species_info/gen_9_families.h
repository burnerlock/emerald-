...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_MAGIC_GUARD, ABILITY_PROTEAN },
    ...
    [SPECIES_FLORAGATO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_MEOWSCARADA}),
    },
    ...
    [SPECIES_SCOVILLAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_INSOMNIA, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FINIZEN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_PALAFIN_ZERO}),
    },
    ...
    [SPECIES_GREAT_TUSK] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_THICK_FAT, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BRUTE_BONNET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_CHLOROPLAST, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_MOLD_BREAKER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_FRIGIBAX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_ARCTIBAX}),
    },
    ...
    [SPECIES_BAXCALIBUR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_THERMAL_EXCHANGE, ABILITY_STRONG_JAW, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MOON_STONE, SPECIES_GHOLDENGO}),
    },
    ...
    [SPECIES_ROARING_MOON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_STRONG_JAW, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_IRON_VALIANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_DOWNLOAD, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_WHITE,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)    \
    {                                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,                                                                                      \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                                                      \
        .abilities = { ability, ABILITY_LIBERO },                                                                         \
        .bodyColor = color,                                                                                             \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_FAIRY, ABILITY_MOLD_BREAKER,                        BODY_COLOR_GREEN, 1, 6, 1, FALSE),
    ...
    [SPECIES_OGERPON_HEARTHFLAME]      = OGERPON_SPECIES_INFO(Hearthflame, Hearthflame,     TYPE_FIRE,  ABILITY_MOXIE,                   BODY_COLOR_RED,   1, 6, 0, FALSE),
    [SPECIES_OGERPON_CORNERSTONE]      = OGERPON_SPECIES_INFO(Cornerstone, Cornerstone,     TYPE_ROCK,  ABILITY_DEFIANT,                         BODY_COLOR_GRAY,  1, 6, 0, FALSE),
#if P_TERA_FORMS
