...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_CHLOROPLAST, ABILITY_EFFECT_SPORE },
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_SOLAR_POWER },
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_TOUGH_CLAWS, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_RED,
...
#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 119 : 85)
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_TOUGH_CLAWS, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_RED,
...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 100 : 85)
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_SOLID_ROCK, ABILITY_MEGA_LAUNCHER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_BEEDRILL}),
    },

    [SPECIES_BEEDRILL] =
    {
        .baseHP        = 75,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 100 : 80,
        .baseDefense   = 50,
        .baseSpeed     = 85,
        .baseSpAttack  = 45,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 90 : 45,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_RIVALRY, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .baseDefense   = 77,
        .baseSpeed     = 95,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 102 : 75,
        .baseSpDefense = 75,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_RIVALRY, ABILITY_SHEER_FORCE },
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_NONE, ABILITY_SHEER_FORCE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .baseDefense   = 70,
        .baseSpeed     = 95,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 55 : 75,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_POISON, TYPE_FLYING),
        .catchRate = 90,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_IRON_FIST, ABILITY_ANGER_POINT, ABILITY_DEFIANT },
    #else
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IRON_FIST, ABILITY_INNER_FOCUS, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .baseDefense   = 65,
        .baseSpeed     = 100,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 100 : 120,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_WATER, TYPE_POISON),
        .catchRate = 60,
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_STURDY, ABILITY_SHELL_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TAEKWONDO, ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SCRAPPY, ABILITY_SHARPNESS, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Farfetch'd"),
        .cryId = CRY_FARFETCHD,
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .baseAttack    = 120,
        .baseDefense   = 75,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 125 : 100,
        .baseSpAttack  = 60,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_GROUND, TYPE_FLYING),
        .catchRate = 45,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_GYARADOS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_MOLD_BREAKER, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gyarados"),
    #if P_MODIFIED_MEGA_CRIES
