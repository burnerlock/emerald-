...
#define B_WEATHER_SUN_CHLOROPLAST (1 << BATTLE_WEATHER_SUN_CHLOROPLAST)
#define B_WEATHER_SUN           (B_WEATHER_SUN_NORMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_SUN_CHLOROPLAST)
...
#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_ICY_ANY | B_WEATHER_STRONG_WINDS | B_WEATHER_FOG | B_WEATHER_SUN_CHLOROPLAST)
