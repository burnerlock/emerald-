...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_TAEKWONDO = 311,
    ABILITY_CHLOROPLAST = 312,
    ABILITY_BLADEMASTER = 313,
    ABILITY_SAGE_POWER = 314,
    ABILITY_POWER_FISTS = 315,
    ABILITY_SAND_SONG = 316,
    ABILITY_MUAY_THAI = 317,
